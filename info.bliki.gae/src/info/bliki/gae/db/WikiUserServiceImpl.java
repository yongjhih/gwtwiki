...
public class WikiUserServiceImpl implements WikiUserService {
  ...
  @Override
  public WikiUser save(WikiUser wikiUser) {
  ...
  @Override
  public WikiUser update(WikiUser wikiUser) {
  ...
  @Override
  public void delete(WikiUser wikiUser) {
  ...
  @Override
  public WikiUser findByEMail(String email) {

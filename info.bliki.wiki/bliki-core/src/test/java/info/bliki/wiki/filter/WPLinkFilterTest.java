...
public class WPLinkFilterTest extends FilterTestSupport {
	...
	public void testLink6() {
		assertEquals(
				...
				wikiModel.render("[[Test:hello world|]]"));
	}
	...
	public void testLink8() {
		assertEquals("\n"
				...
				wikiModel.render("[[Boston, Massachusetts|]]"));
	}
	...
	public void testSpecialLink01() {
		assertEquals(
				...
				wikiModel.render("* [[Special:Specialpages|Special Pages]]"));
	}
	...
	public void testSubLink04() {
		assertEquals("\n"
				...
				wikiModel.render("[[Hello World?id=42]]"));
	}

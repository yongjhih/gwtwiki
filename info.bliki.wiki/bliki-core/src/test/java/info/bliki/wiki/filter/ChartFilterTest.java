...
public class ChartFilterTest extends FilterTestSupport {
	...
	public void testChart001() {
		assertEquals(
				...
				wikiModel
						.render("<chart cht=bvs chs=800x300 chbh=20,1 chxt=x,y chco=76A4FB chls=2.0 chd=t:1,2,3,6,9,13,20,28,37,49,60,72,83,92,98,100,98,92,83,72,60,49,37,28,20,13,9,6,3,2,1 />"));
	}

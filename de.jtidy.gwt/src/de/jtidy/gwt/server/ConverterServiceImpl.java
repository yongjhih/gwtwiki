...
public class ConverterServiceImpl extends RemoteServiceServlet implements
    ConverterService {
  /**
	 * 
	 */
  ...
  public String convert(String expression, HashMap<String, String> map,
      int counter) {
    if (expression == null) {
      return "";
    }
  ...
  private String generateCode(String expression, String convertType,
      SourceCodeFormatter f) {
    String result;
